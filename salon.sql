...
1	# Validate service ID	SERVICE_NAME=$($PSQL "SELECT name FROM services WHERE service_id=$SERVICE_ID_SELECTED;")
\.
...
--
-- Name: appointments fk_serviceappointment; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: appointments fr_customerappointment; Type: FK CONSTRAINT; Schema: public; Owner: -
--
